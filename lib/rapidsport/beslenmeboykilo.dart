          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 313 * fem, 20 * fem),
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BeslenmeHedef()));
                  },
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 8 * fem, 28 * fem),
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(13 * fem, 0 * fem, 13 * fem, 34 * fem),
                padding:
                    EdgeInsets.fromLTRB(13 * fem, 14 * fem, 13 * fem, 14 * fem),
                width: 348 * fem,
                decoration: BoxDecoration(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(14 * fem, 0 * fem, 0 * fem, 35 * fem),
                child: Text(
                  'Boyun kaç (cm)?',
                  textAlign: TextAlign.center,
                  style: safeGoogleFont(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BeslenmeFiziksel()));
                  },
                  style: TextButton.styleFrom(
                    padding: EdgeInsets.zero,
                  ),
