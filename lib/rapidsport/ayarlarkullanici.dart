...
class AyarlarKullanici extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // ellipse25Mo (33:1137)
                                margin: EdgeInsets.fromLTRB(0*fem, 19*fem, 93*fem, 0*fem),
                                width: 70*fem,
                                height: 70*fem,
                                decoration: BoxDecoration (
            ...
            Container(
              // profileqNu (33:1143)
              margin: EdgeInsets.fromLTRB(18*fem, 0*fem, 0*fem, 8.5*fem),
              child: Text(
                'PROFİL',
                style: safeGoogleFont (
                  'Inter',
            ...
            Container(
              // line1udf (33:1153)
              margin: EdgeInsets.fromLTRB(2.98*fem, 0*fem, 5.02*fem, 18.5*fem),
              width: double.infinity,
              height: 1*fem,
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(3*fem, 0*fem, 0*fem, 29.5*fem),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
            ...
            GestureDetector(
              onTap:(){Navigator.push(context, MaterialPageRoute(builder: (context) => const Fiyatlandirma())
                  );},
              child: Container(
                // group34114pxD (238:1084)
                margin: EdgeInsets.fromLTRB(3*fem, 0*fem, 5.04*fem, 16*fem),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const OdemeYontemi())
                  );
              },
              child: Container(
                // group34115BwB (238:1085)
                margin: EdgeInsets.fromLTRB(4*fem, 0*fem, 4.04*fem, 38*fem),
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(16*fem, 0*fem, 15.69*fem, 0*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
