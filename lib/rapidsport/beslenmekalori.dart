          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 311 * fem, 76 * fem),
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BeslenmeOgun()));
                  },
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(4 * fem, 0 * fem, 0 * fem, 57 * fem),
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(86 * fem, 0 * fem, 86 * fem, 24 * fem),
                width: double.infinity,
                height: 180 * fem,
              ...
              Container(
                // frame40U9s (53:1723)
                margin:
                    EdgeInsets.fromLTRB(5 * fem, 0 * fem, 0 * fem, 12 * fem),
                width: 348 * fem,
                height: 58 * fem,
                decoration: BoxDecoration(
              ...
              Container(
                // frame41qed (53:1726)
                margin:
                    EdgeInsets.fromLTRB(5 * fem, 0 * fem, 0 * fem, 9.5 * fem),
                width: 348 * fem,
                height: 58 * fem,
                decoration: BoxDecoration(
                  color: const Color(0x660d9a57),
              ...
              Container(
                // frame402DK (53:1729)
                margin:
                    EdgeInsets.fromLTRB(5 * fem, 0 * fem, 0 * fem, 44.5 * fem),
                width: 348 * fem,
                height: 63 * fem,
                decoration: BoxDecoration(
                  color: const Color(0x660d9a57),
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BeslenmeProgramsiz()));
                  },
                  style: TextButton.styleFrom(
                    padding: EdgeInsets.zero,
                  ),
