                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      padding: EdgeInsets.fromLTRB(8*fem, 7*fem, 8*fem, 23*fem),
                      width: double.infinity,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const AntrenmanProgrami())
                  );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const BeslenmeProgrami())
                  );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const AyarlarKullanici())
                  );
                    },
                    child: Container(
